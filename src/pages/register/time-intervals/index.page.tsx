...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    // novo transform para calcular o tempo em minutos
    .transform((intervals) => {
    ...
    // nova validação para diferença de pelo menos 1 hora
    .refine(
      (intervals) => {
...
export default function TimeIntervals() {
  ...
  const { fields } = useFieldArray({
    control, // vem do react hook form e serve para referenciar qual formulario estamos lidando
    name: 'intervals',
  })
      ...
      <IntervalBox as="form" onSubmit={handleSubmit(handleSetTimeIntervals)}>
        <IntervalContainer>
          {fields.map((field, index) => {
            return (
              // o ID é gerado automaticamente pelo react hook form
